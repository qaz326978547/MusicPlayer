...
function createMusicPlayer(data, i) {
    ...
    progressWrapper.addEventListener("mousedown", function (event) {
        ...
        audioTrack.currentTime = (clickedPosition / event.target.offsetWidth) * audioTrack.duration - 60;
    ...
    playBtn.onclick = function () {
        ...
        audioTrack.ontimeupdate = function () {
            var progressInPercent = (audioTrack.currentTime / audioTrack.duration) * 100;
...
function createMusicCardList(data, i) {
    ...
    musicCardlist.onclick = function () {
        ...
        playAudio.ontimeupdate = function () {
            var progressInPercent = (playAudio.currentTime / playAudio.duration) * 100;
